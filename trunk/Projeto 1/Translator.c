...
/*Retorna uma lista com as chaves e valores vindas do arquivo de transucao, Parametro é o caminho do arquivo*/
...
/*Retorna o valor associado a chave, recebe como parametros a lista de transução e uma chave*/
